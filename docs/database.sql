...
(
	...
	stack_1 VARCHAR (255) NOT NULL DEFAULT "javascript",
	stack_2 VARCHAR (255) NOT NULL DEFAULT "javascript",
	stack_3 VARCHAR (255) NOT NULL DEFAULT "javascript",
	stack_4 VARCHAR (255) NOT NULL DEFAULT "javascript",
	stack_5 VARCHAR (255) NOT NULL DEFAULT "javascript",
	stack_6 VARCHAR (255) NOT NULL DEFAULT "javascript",
